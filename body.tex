...
\begin{table}[!p]
    ...
    \caption{
        ...
        $^{*}$ Note: multiband photo-z redshifts and grism redshifts with confidence < 0.95 were not used in any training sets employed in this note.
    }
...
will be % are also 
hosted on the PZ Server, along with their respective metadata and documentation. A list with access instructions and links to product pages will be available on the  \href{https://docs.linea.org.br/en/data/pz_server_data.html#data-preview-1}{data products documentation page}. There are two ways to access these data products: 
...
\label{sec:performance:pz:flags}
...
\begin{figure*}
\centering
\includegraphics[width=0.24\linewidth]{figures/fzboost_mode_desi.png}
\includegraphics[width=0.24\linewidth]{figures/knn_mode_desi.png}
\includegraphics[width=0.24\linewidth]{figures/cmnn_mode_desi.png}
\includegraphics[width=0.24\linewidth]{figures/dnf_mode_desi.png}
\includegraphics[width=0.24\linewidth]{figures/tpz_mode_desi.png}
\includegraphics[width=0.24\linewidth]{figures/gpz_mode_desi.png}
\includegraphics[width=0.24\linewidth]{figures/bpz_mode_desi.png}
\includegraphics[width=0.24\linewidth]{figures/lephare_mode_desi.png}
